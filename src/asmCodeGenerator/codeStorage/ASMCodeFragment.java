...
public class ASMCodeFragment {
	...
	public ASMCodeFragment makeCopy() {
		ASMCodeFragment frag = new ASMCodeFragment(this.codeType);
		frag.chunks = new ArrayList<ASMCodeChunk>();
		for (ASMCodeChunk chunk: this.chunks) {
			frag.chunks.add(chunk.makeCopy());
		}
		return frag;
	}
	
	public List<ASMCodeChunk> getCodeChunks() {
		return chunks;
	}
