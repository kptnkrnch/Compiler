...
public class FixtureDefinitions {
	...
	public static final String COMMENTS_TOKEN_PRINTER_INPUT_FILENAME     = FIXTURE_DIRECTORY + "commentsTest.pika";
	public static final String COMMENTS_TOKEN_PRINTER_EXPECTED_FILENAME  = FIXTURE_DIRECTORY + "commentsTestTokens.txt";
