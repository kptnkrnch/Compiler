...
public class ParseNode {
	...
	Type promotedFromType;
	boolean targetable;

	public ParseNode(Token token) {
		this.token = token;
		this.type = PrimitiveType.NO_TYPE;
		this.promotedFromType = PrimitiveType.NO_TYPE;
		this.scope = null;
	...
	public ParseNode(ParseNode node) {
		...
		this.type = node.type;
		this.promotedFromType = node.promotedFromType;
...
// attributes
	...
	public void promoteType(Type type) {
		this.promotedFromType = this.type;
		this.type = type;
	}
	
	public int getTypeHeaderSize() {
		return type.getHeaderSize();
	}
